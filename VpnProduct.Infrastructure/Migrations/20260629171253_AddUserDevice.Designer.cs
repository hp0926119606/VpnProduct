...
namespace VpnProduct.Infrastructure.Migrations
{
    ...
    [Migration("20260629171253_AddUserDevice")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("VpnProduct.Domain.Entities.UserDevice", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.Property<Guid?>("VpnPeerId")
                        .HasColumnType("uuid");

                    b.HasKey("Id");

                    b.HasIndex("VpnPeerId");
            ...
            modelBuilder.Entity("VpnProduct.Domain.Entities.UserDevice", b =>
                {
                    b.HasOne("VpnProduct.Domain.Entities.VpnPeer", "VpnPeer")
                        .WithMany()
                        .HasForeignKey("VpnPeerId");

                    b.Navigation("VpnPeer");
                });
